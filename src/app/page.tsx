...
import { fetchGames, TC_LABELS, type GameSummary, type TimeControlBucket, type Platform, ALL_TIME_CONTROLS } from './chess/opening-stats/lib/fetchGames'
import { analyzeGamesAsync, aggregateStats, type GameAnalysis, type OpeningStats } from './chess/opening-stats/lib/analyzeOpenings'
import { getEvalDisplayColor } from './chess/opening-stats/lib/evalDisplay'
import { evaluateFen } from './chess/opening-stats/lib/stockfishEval'
import { GameInput, type GameInputValues, type GameInputInitialValues } from './chess/opening-stats/components/GameInput'
import { AnalysisProgress } from './chess/opening-stats/components/AnalysisProgress'
import { OpeningFrequency } from './chess/opening-stats/components/OpeningFrequency'
import { OpeningBreakdown } from './chess/opening-stats/components/OpeningBreakdown'
import { GameCarousel } from './chess/opening-stats/components/GameCarousel'
import styles from './chess/opening-stats/page.module.css'
  ...
  return (
    <main className={styles.page}>
      ...
      <footer className={styles.footer}>
        <a
          href="https://github.com/cindehaa/chess-opening-stats"
          target="_blank"
